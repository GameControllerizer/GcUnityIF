...
/*
 * GameControllerizer Interface description for Unity InputSystem.
 * Change this code if you want to remap buttons.
 * 
 * 2021.08.21 Nobuhiro DOI
 */

[InputControlLayout(stateType = typeof(GcStateTypeInfo2))]
#if UNITY_EDITOR
[InitializeOnLoad]
#endif
...
/*
 * GameControllerizer Firmware version == 2 (latest)
 */
[StructLayout(LayoutKind.Explicit, Size = 7)]
public struct GcStateTypeInfo2 : IInputStateTypeInfo
{
...
/*
 * GameControllerizer Firmware version == 1 (discontinued, not verified)
 */
